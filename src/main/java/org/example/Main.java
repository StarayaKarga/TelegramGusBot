...
public class Main extends TelegramLongPollingBot {
    //IvanGoItCourseBot
    //6215256784:AAF86kP-a9ooq5vWIVpdHjWUhjR84Nb9cT4
    ...
    public void onUpdateReceived(Update update) {
        ...
        /*SendMessage msg = createMessage("*Hello*, Ivan!");
    ...
    public String getBotToken(){
        return "6215256784:AAF86kP-a9ooq5vWIVpdHjWUhjR84Nb9cT4";
    }

    @Override
    public String getBotUsername() {
        return "IvanGoItCourseBot";
    }
    ...
    public SendMessage createMessage(String text){
        ...
        message.setParseMode("markdown"); //format message
        return message;
    }
